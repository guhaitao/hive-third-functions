...
@Description(name = "to_json",
        value = "_FUNC_(struct, convert_to_lower_case) - Returns a JSON string from an arbitrary Hive structure."
)
        ...
        public void generateJson(JsonGenerator gen, Object obj) throws JsonGenerationException, IOException {
            if (obj == null) {
                ...
                while (iter.hasNext()) {
                    ...
                    if (convertFlag) {
                        gen.writeFieldName(keyJson.toLowerCase());
                    } else {
        ...
        public void generateJson(JsonGenerator gen, Object obj) throws JsonGenerationException, IOException {
            ...
            if (obj == null) {
                ...
                for (int i = 0; i < fieldNames.size(); ++i) {
                    ...
                    if (convertFlag) {
                        gen.writeFieldName(fieldName.toLowerCase());
                    } else {
    ...
    private class TimestampInspectorHandle implements InspectorHandle {
        ...
        public void generateJson(JsonGenerator gen, Object obj) throws JsonGenerationException, IOException {
            if (obj == null) {
                ...
                String timeStr = isoFormatter.print(timestamp.toEpochMilli());
...
//                String timeStr = isoFormatter.print(timestamp.toEpochMilli());
    ...
    private class DecimalInspectorHandle implements InspectorHandle {
        ...
        public void generateJson(JsonGenerator gen, Object obj) throws JsonGenerationException, IOException {
            if (obj == null) {
                ...
                HiveDecimal decimal = decimalInspector.getPrimitiveJavaObject(obj);
                gen.writeNumber(decimal.bigDecimalValue());
            }
        }
    }
    ...
    public ObjectInspector initialize(ObjectInspector[] args)
        ...
        if (args.length != 1 && args.length != 2) {
            throw new UDFArgumentException(" ToJson takes an object as an argument, and an optional to_lower_case flag");
        }
